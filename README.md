...
You should repeat the procedure for all possible <img src="sigma_over_T1.png" width="30px" height="30px"> and  <img src="https://render.githubusercontent.com/render/math?math=$\alpha_{1}$"> values.
